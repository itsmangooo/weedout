...
export function AppShell() {
  ...
  return <div className={`workspace-shell app-shell ${menuOpen ? "is-nav-open" : ""}`}>
    ...
    <div className="workspace-body"><aside className="workspace-rail"><LiquidGlass className="app-sidebar__panel workspace-navigation" id={menuId} interactive>
    ...
    </LiquidGlass></aside><main tabIndex={-1} id="main" className="workspace-content app-shell__main"><PageTransition key={pathname}><Outlet /></PageTransition></main></div>
  </div>;
}
